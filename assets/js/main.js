...
$(document).on("click", "#whatsappA", function () { window.open("https://wa.me/+51994935162/?text=¡Hola!, vi su sitio en Google, me interesa solicitar una consulta con el Cirujano Bariatra.") }),
$(document).on("click", "#telefono", function () { window.open("tel:994935162") }),
$(document).on("click", "#ubicacion", function () { window.open("https://maps.app.goo.gl/grK8iNdECZgYDByz9") }),
$(document).on("click", "#correo", function () { window.open("mailto:villavicenciorafo@yahoo.com") })